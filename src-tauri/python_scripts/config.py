...
def setup_config(translator=None):
    ...
    try:
        ...
        default_config = {
            ...
            'Proxy': {
                'enabled': 'False',  # Enable proxy by default
                'http_proxy': '127.0.0.1:7890',  # HTTP proxy address
                'https_proxy': '127.0.0.1:7890',  # HTTPS proxy address
                'socks_proxy': '',  # SOCKS proxy address (optional)
