...
interface UsageProgressModalProps {
  isOpen: boolean;
  onClose: () => void;
  token: string;
...
export const UsageProgressModal: React.FC<UsageProgressModalProps> = ({
  isOpen,
  onClose,
  token,
  onShowToast,
  ...
  useEffect(() => {
    if (
      ...
      // 先重置为0
      setDisplayProgress(0);
      // 使用 requestAnimationFrame 确保重置生效后再设置目标值
  ...
  return (
    <div className="fixed left-0 top-0 z-50 !mt-0 flex h-full w-full items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="panel-floating relative max-h-[90vh] w-full max-w-4xl overflow-y-auto rounded-xl shadow-2xl">
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-slate-50/95 p-6 backdrop-blur dark:border-slate-800 dark:bg-slate-900/95">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">📊 使用进度详情</h2>
          <button
            onClick={onClose}
            className="text-slate-500 transition-colors hover:text-slate-700 focus:outline-none dark:text-slate-400 dark:hover:text-slate-200"
            title="关闭"
            aria-label="关闭弹窗"
          >
            <svg
        ...
        <div className="p-6">
          ...
          {loading && !progressData ? (
            ...
            >
              {/* 进度条部分 */}
              <div className="p-6 rounded-lg shadow-sm bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-900 dark:to-slate-900">
                <div className="mb-4">
              ...
              {spendLimit && (
                <div className="surface-elevated rounded-lg p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-500/15">
                      <p className="text-sm text-slate-600 dark:text-slate-300">剩余额度</p>
                      <p className="text-2xl font-bold text-purple-600">
                        $
                        {spendLimit.individualLimitDollars?.toFixed(2) ||
                          "0.00"}
                      </p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">
              ...
              {planUsage && (
                <div className="surface-elevated rounded-lg p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="p-4 rounded-lg bg-orange-50 dark:bg-orange-500/15">
                    ...
                    <div className="p-4 rounded-lg bg-green-50 dark:bg-green-500/15">
                    ...
                    <div className="p-4 rounded-lg bg-yellow-50 dark:bg-yellow-500/15">
                    ...
                    <div className="p-4 rounded-lg bg-indigo-50 dark:bg-indigo-500/15">
                      <p className="text-sm text-slate-600 dark:text-slate-300">剩余额度</p>
                  ...
                  {planUsage.remainingBonus !== undefined && (
                    <div className="flex items-center gap-2 p-3 rounded bg-blue-50 dark:bg-blue-500/15">
              ...
              {(billingCycleStart || billingCycleEnd) && (
                <div className="p-4 rounded-lg bg-gradient-to-r from-purple-50 to-blue-50 dark:from-slate-900 dark:to-slate-900">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                >
                  {loading ? "刷新中..." : "🔄 刷新数据"}
                </button>
              </div>
